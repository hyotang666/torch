...
(defun function-graph(function &key (ignore-privates *ignore-privates*)
			       (type :png)
			       system
			       direction)
  #.(doc :torch "doc/function-graph.md")
  (let*((graph(graph(or system
			(string-downcase(package-name(symbol-package(ensure-name function)))))))
